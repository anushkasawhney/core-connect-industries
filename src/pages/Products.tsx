    ...
    <section className="section-padding bg-surface">
      <div className="container-wide mx-auto text-center">
        ...
        <div className="flex justify-center">
          <a href="https://drive.google.com/file/d/1fKYaZIIg5AFB3Qex5LUQidake2_iLeDU/view" target="_blank" className="px-8 py-4 rounded-md gradient-navy text-primary-foreground font-semibold text-sm hover:opacity-90 transition-opacity inline-block">
