...
export const industries: Industry[] = [
  ...
  { name: "Pharmaceutical", icon: "Pill", description: "FDA-grade hoses, PTFE gaskets, and hygienic rubber products for pharma plants.", details: "The pharmaceutical industry demands the highest levels of hygiene, chemical resistance, and compliance. FDA-grade silicone hoses, PTFE-lined pipes, and chemically inert gaskets are critical for maintaining product purity and meeting regulatory standards in drug manufacturing.", brandContribution: "Dupon Industrial supplies FDA-grade silicone hoses for clean fluid transfer, SS/PTFE hose assemblies for corrosive chemical handling, PTFE gaskets for reactor and pipeline flanges, and electrical insulation mats for pharma plant panel rooms. Our products ensure contamination-free operations and help pharmaceutical manufacturers maintain GMP compliance.", image: industryPharmaceutical },
